...
const CategoryCard = ({ name, _id }) => {
  ...
  return (
    <Link href={`/category/${_id}`}>
      <div
        key={_id}
        className="bg-white rounded-lg p-10 h-64 w-48 flex flex-col justify-center items-start gap-8 font-semibold text-lg cursor-pointer hover:bg-violet-500 hover:text-white basis-48 shrink-0 grow-0"
      >
